...
module Dry
  class Animal
    ...
    def self.makes_noise(name)
      # When an Animal subclass calls `makes_noise`, we will *dynamically*
      # define a new method on the subclass. `Class#define_method` is an
      # instance method of the `Class` class.
